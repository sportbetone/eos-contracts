...
static constexpr auto bank_account_n = "sportbetdivs"_n;
...
void token::sub_balance(name owner, asset value)
{
  ...
  if (value.symbol == our_symbol)
  {
    const auto amount = value.amount + bank::get_staked(bank_account_n, owner);
    check(amount <= from.balance.amount, "overdrawn balance");
  } else
  {
